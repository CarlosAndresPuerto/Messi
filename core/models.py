...
class Task(models.Model):
    ...
    archivo = models.FileField(upload_to='contenido_profesor/', null=True, blank=True)
    def __str__(self):
...
class EntregaTarea(models.Model):
    ...
    archivo_entrega = models.FileField(upload_to='entregas/', validators=[FileExtensionValidator(allowed_extensions=['pdf', 'doc', 'docx'])], null=True)
