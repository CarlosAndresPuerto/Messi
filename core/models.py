...
class CustomUser(AbstractUser):
    ...
    teacher_password = models.CharField(max_length=18, blank=True, null=True)
    first_name = models.CharField(max_length=15, null=True)
    last_name = models.CharField(max_length=15, null=True)
    identity = models.IntegerField(unique=True, null=True, validators=[MaxValueValidator(10)])
...
def create_user_profile(sender, instance, created, **kwargs):
    if created and instance.is_teacher and not instance.teacher_password:
        print(f"Creating teacher profile for user: {instance.username}")
