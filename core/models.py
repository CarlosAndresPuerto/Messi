...
class EntregaTarea(models.Model):
    ...
    fecha_entrega = models.DateTimeField(default=timezone.now, null=True)

    def con_retraso(self):
        return self.entregada and self.fecha_entrega > self.tarea.datecompleted

    def get_tarea_info(self):
        return f"{self.tarea.title} - {self.tarea.project.name} - Fecha de entrega: {self.tarea.datecompleted}"
