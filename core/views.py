...
def submit_task(request, task_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            entrega_tarea.fecha_entrega = timezone.now()
            print(f"Fecha y hora antes de guardar: {entrega_tarea.fecha_entrega}")
            entrega_tarea.save()

            print(f"Entrega guardada con ID: {entrega_tarea.id}")
