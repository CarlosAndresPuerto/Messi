...
class TaskSubmissionForm(forms.ModelForm):
    class Meta:
        model = EntregaTarea
        exclude = ['fecha_entrega']  # Excluir el campo 'fecha_entrega'

    def __init__(self, *args, **kwargs):
        super(TaskSubmissionForm, self).__init__(*args, **kwargs)
        
        # Cambia la forma de agregar el campo oculto usando el widget HiddenInput
        self.fields['entregada'].widget = forms.HiddenInput()
        self.initial['entregada'] = True
        
        # Otros ajustes o personalizaciones del formulario, si es necesario
